...
** ==========================
**
import excel "dta_muni/INAFED_Vivienda2005.xlsx", sheet("data") firstrow clear

** 
drop if id_municipio == 0

**
keep estado municipio id_estado id_municipio vph_compu vph_con_bienes
**
...
**
save "dta_muni/muni_data_2005_vivienda.dta", replace
...
** ==========================
**
import excel "dta_muni/INAFED_Poblacion2005.xlsx", sheet("data") firstrow clear
...
**
save "dta_muni/muni_data_2005_poblacion.dta", replace
...
** ==========================
**
import excel "dta_muni/INAFED_Educacion2005.xlsx", sheet("data") firstrow clear
...
** 
save "dta_muni/muni_data_2005_educacion.dta", replace


** ==========================
** Integrated Data Set in 2005
** ==========================

**
use "dta_muni/muni_data_2005_poblacion.dta", clear

** 
merge 1:1 muni_code using "dta_muni/muni_data_2005_educacion.dta"
drop _merge

** 
merge 1:1 muni_code using "dta_muni/muni_data_2005_vivienda.dta"
drop _merge

** 
save "dta_muni/muni_data_2005_census.dta", replace
